...
COPY public.followers (net_id, club_id, admin, member, name, club_name) FROM stdin;
sdduncan	2	t	t	Sean	Water Polo
john	2	t	t	John	Water Polo
sdduncan	1	f	t	Sean	Fencing
sdduncan	3	f	f	Sean	Wrestling
\.
